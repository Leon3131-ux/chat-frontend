...
export class ApiService {
  ...
  getAll(path: String, params?: {params: any}, errorHandler: HttpResponseErrorHandler = this.defaultErrorHandler): Observable<any[]>{
  ...
  getSingle(path: String, errorHandler: HttpResponseErrorHandler = this.defaultErrorHandler): Observable<any>{
